...
const SearchBienGroupe = () => {
  ...
  const { isLoading, isError, data: bien, refetch } = useQuery(
    ...
    () =>
      axios.get(
        `https://arcane-spire-42874.herokuapp.com/api/properties?maxTravelers[gte]=1&maxTravelers[lte]=5`
      ),
      ...
      <Box minHeight="70vh">
        ...
        >
          <Heading as="h1" textAlign="center" margin={[0, 10, 10, 10, 20]}>
            Découvrez notre sélection pour partir en groupe!
          </Heading>
        </Box>
        <SimpleGrid
...
export default SearchBienGroupe;
